...
const COLS = 10, ROWS = 16, BLOCK = 24;
...
+document.getElementById('btn-rotate').addEventListener('touchstart', e => { e.preventDefault(); tryRotate(); });
